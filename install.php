...
* 
*     $Id: install.php,v 1.21 2000/12/04 09:20:23 thefinn Exp $
* 
****************************************************************************/
	    ...
	    <FORM METHOD="POST" ACTION="<?php echo $PHP_SELF ?>">
	           <TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" ALIGN="CENTER" VALIGN="TOP" WIDTH="95%">
	                 ...
	                 <TABLE BORDER="0" CELLPADDING="1" CELLSPACING="1" WIDTH="100%">
	                       ...
	                       <TD COLSPAN="2">Now that you have created your database you must create an 'Administrator', a user who will be able to alter the settings of the forum.</TD>
	                       </TR>
	                       <TR>
	   <TR ALIGN="LEFT">
...
?>
	...
	<TD><INPUT TYPE="TEXT" NAME="email_from" SIZE="30" MAXLENGTH="100"></TD>
	</TR>         
	<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD>Email Signature:<br><font size="-1"><i>(This is the email signature that will appear at the end of all emails sent by the forums)
	<TD><TEXTAREA NAME="email_sig" ROWS="5" COLS="15"></TEXTAREA></TD>                                                    
	</TR>  
	<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD>Allow HTML:</TD>
	...
	<TD><INPUT TYPE="TEXT" NAME="hot" SIZE="3" MAXLENGTH="3"></TD>
	</TR>
	<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
...
<?php	
    ...
    case 'options':
      ...
      if($config_file[count($config_file)] != "?>") {
	...
	die("<font color=\"#FF0000\">Error, I could not connect to the database at $dbserver. Using username $dbuser and password $dbpass.<BR>Please go back and try again.");
      ...
      $sql = "INSERT INTO config (sitename, allow_html, allow_bbcode, allow_sig, hot_threshold, posts_per_page, topics_per_page, allow_theme_create, email_from, email_sig, selected) ";
      $sql .= "VALUES ('$name', $html, $bb, $sig, $hot, $ppp, $tpp, 0, '$email_from', '$email_sig', 1)";
...
?>
	...
	<TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" ALIGN="CENTER" VALIGN="TOP" WIDTH="95%">
	      ...
	      <TABLE BORDER="0" CELLPADDING="1" CELLSPACING="1" WIDTH="100%">
	            ...
	            <TD BGCOLOR="#2E4460"><INPUT TYPE="TEXT" NAME="dbserver" SIZE="30"></TD>
	            </TR>
	            <TR>
                    <TD BGCOLOR="#6C706D">Database Name:</TD>
	            <TD BGCOLOR="#2E4460"><INPUT TYPE="TEXT" NAME="dbname" SIZE="30"></TD>
	            <TR>
	            <TD BGCOLOR="#6C706D">Database User name:</TD>
	            <TD BGCOLOR="#2E4460"><INPUT TYPE="TEXT" NAME="dbuser" SIZE="30"></TD>
	            </TR>
	            <TR>
