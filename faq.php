...
/***************************************************************************
    ...
    $Id: faq.php,v 1.5 2000/11/15 04:57:15 thefinn Exp $
...
<table border="0" width="100%" bgcolor=>
    ...
    <tr bgcolor="<?php echo $color2?>">
        <td>
          ...
          <a href="#HTML">Can I add HTML to my messages?</a><br>
    ...
    <tr bgcolor="<?php echo $color2?>">
        <td>
	<font size="<?php echo $FontSize2?>" face="<?php echo $FontFace?>" color="<?php echo $textcolor?>">
	Youve probably seen others use smilies before in email messages or other
	...
	This bulletin board
        ...
        representation. For example, if you type 
	:D
	in your BB post, it will  automatically be converted to 
	<img src="<?php echo $url_images?>/smiles/icon_biggrin.gif"> - a big grin. The
        following smilies are currently supported: </font><BR>
...
?>
		 <TR BGCOLOR="<?php echo $color2?>"><TD width="100"><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><?php echo $smile[code]?></FONT></td><td width="50%"><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"> <?php echo $smile[emotion]?>&nbsp;</FONT></td><td width="55"> <IMG SRC="<? echo "$url_smiles/$smile[smile_url]";?>"></td></tr>
<?php
	     }
	  } else 
...
?>
    ...
    <tr bgcolor="<?php echo $color2?>">
        <td>
	<font size="<?php echo $FontSize2?>" face="<?php echo $FontFace?>" color="<?php echo $textcolor?>">
	You may be able to use HTML and/or BB Code in your posts, if your
        administrators and moderators have those options turned
        on. 
	Every time you
        post a new note, you will be told whether BB Code and/or
        HTML is enabled. If HTML is on,
        you may use any HTML tags, but please be very careful
        that you proper HTML syntax. If you do not, your
        moderator or administrator may have to edit your post.
        BB Code is similar to HTML, but offers just a few basic
        functions, such as hyperlinking, image display, bolding
        and italicizing. A complete list of current BB Codes are
        <a href="bbcode_ref.<?php echo $phpEx?>">listed here</a>. </font>
	</td>
    </tr>
    <tr bgcolor="<?php echo $color1?>"> 
        <td nowrap>
    ...
    <tr bgcolor="<?php echo $color2?>">
	    ...
	    boardom risk having there topics closed, removed and/or membership revoked. </p>
	...
	by selecteding from the themes that the administration has provided. Also, if the administrator allows it you may have the option of
	...
	at this time only the administrator my change the images for each theme. When a user creates a theme the images from the forums default theme
	will be selected.
	...
	This bulletin board uses cookies to store the following information:
        ...
        these time-saving features will not work properly. </font>
	</td>
    </tr>
    <tr bgcolor="<?php echo $color1?>">
        <td><a name="edit">
	...
	You may use a signature on your posts.
        ...
        profile. <p>Note: You may use HTML or <a href="bbcode_ref.html">BB Code</a> if the admin has 
	set this option to on.</font>
        </p>
        </td>
    </tr>
    <tr bgcolor="<?php echo $color1?>">
	...
	For security reasons, you may not attach files to any posts. You may
        ...
        outside documents. File attachements will be included in futures versions of phpBB.</font>
	</td>
    </tr>
    <tr bgcolor="<?php echo $color1?>">
        <td>
	...
	You may search for specific posts based on a word or words found in the
        posts, user name, date, and particular forum(s). Just
    ...
    <tr bgcolor="<?php echo $color2?>">
        <td>
	<font size="<?php echo $FontSize2?>" face="<?php echo $FontFace?>" color="<?php echo $textcolor?>">
 	In the even that you lose you password you can click on the &quot;Forgotten your password?&quot; link provided in the
	...
	The system will then email a new, randomly generated, password to the email address listed in your profile, if if you supplied the correct email address.</FONT>
	</td>
    </tr>
    <tr bgcolor="<?php echo $color1?>">
        <td>
	...
	methods to classify it's users by activity on the <?php echo $sitename?> Forums through the number of posts.</p>
	<br>
	...
	// The rank image has not been implemented at this time.
        if($m[rank_image] != '') 
	   echo "<TD><img src=\"$m[rank_image]\"></TD>";
	else
	   echo "<TD>&nbsp;</TD>";
	echo "</TR>";
	...
	echo "<TR BGCOLOR=\"$color2\" ALIGN=\"CENTER\">";
	echo "<TD COLSPAN=\"3\">No Ranks in the database</TD>";
	echo "</TR>";
	}
	?>
	</TABLE></TABLE></font>
	...
	Flaming icons signify that there are <?php echo $hot_threshold?> or more posts in that
        ...
        thread may take awhile to load.</font></p>
        </td>
    </tr>
</table>
</TABLE>
