...
/***************************************************************************
    ...
    $Id: admin_users.php,v 1.19 2000/12/09 20:19:10 thefinn Exp $
...
switch($mode) {
	case 'moduser':
		...
		echo "<tr><td align=\"center\" width=\"100%\" bgcolor=\"$color1\"><font face=\"$FontFace\" size=\"$FontSize1\" color=\"$FontColor\"><B>User Information Updated.</B></font></td>";
		echo "</tr><TR><TD><TABLE width=\"100%\" cellspacing=\"0\" cellpadding=\"0\"><TR>";
		echo "<td align=\"center\" width=\"100%\" bgcolor=\"$color2\"><font face=\"$FontFace\" size=\"$FontSize1\" color=\"$FontColor\"><P><BR>&nbsp;&nbsp;Click <a href=\"$url_admin\">here</a> to return to the Administration Panel.<P>Click <a href=\"$PHP_SELF?mode=moduser\">here</a> to modify another user.</font><P><BR><P></TD>";
 ...
 case 'badwords':
   if($action) {
	 ...
	 if($word != '' && $replacement != '') {
	    ...
	    $sql = "INSERT INTO words (word, replacement) VALUES ('$word', '$replacement')";
	    if(!$r = mysql_query($sql, $db)) {
	 ...
	 $word = addslashes($word);
	 $replacement = addslashes($replacement);
	 $sql = "UPDATE words SET word = '$word', replacement = '$replacement' WHERE word_id = '$word_id'";
	 if(!$r = mysql_query($sql, $db)) {
...
<?php
   ...
   if($m = mysql_fetch_array($r)) {
	 ...
	 echo "<TD><INPUT TYPE=\"TEXT\" NAME=\"word\" VALUE=\"" . stripslashes($m[word]) . "\" MAXLENGTH=\"50\" SIZE=\"25\"></TD>\n";
...
?>
     ...
     <TR BGCOLOR="<?php echo $color2?>" ALIGN="CENTER">
             <TD colspan="2"><INPUT TYPE="TEXT" NAME="word" MAXLENGTH="50" SIZE="25"></TD>
...
<?php
	...
	case 'remuser':
		if($submit) {
		   ...
		   echo "<TABLE width=\"95%\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bordercolor=\"$table_bgcolor\">";
		   echo "<tr><td align=\"center\" width=\"100%\" bgcolor=\"$color1\"><font face=\"$FontFace\" size=\"$FontSize1\" color=\"$FontColor\"><B>User Removed.</B></font></td>";
		   echo "</tr><TR><TD><TABLE width=\"100%\" cellspacing=\"0\" cellpadding=\"0\"><TR>";
